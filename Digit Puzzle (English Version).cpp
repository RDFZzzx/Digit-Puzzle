...
void Print_game_board()
{
	...
	printf("+                                                         +\n");
	printf("+=========================================================+\n");
	printf("+                                + ¡ü¡ý¡û¡úMove the block +\n");
	printf("+                                + to certain position or +\n");
	printf("+  ############################# + turn pages <Tutorial>  +\n");
	printf("+  ##       ##       ##       ## +========================+\n");
	printf("+  ##       ##       ##       ## + Esc:Give up Ctrl:Reset +\n");
	printf("+  ##       ##       ##       ## +========================+\n");
	printf("+  ############################# + If you can't pass the  +\n");
	printf("+  ##       ##       ##       ## + task you can press Alt +\n");
	printf("+  ##       ##       ##       ## + to see the tutorial in +\n");
	printf("+  ##       ##       ##       ## + the problemset page but+\n");
	printf("+  ############################# + you can't update your  +\n");
	printf("+  ##       ##       ##       ## +  score after that.     +\n");
	printf("+  ##       ##       ##       ## +========================+\n");
	printf("+  ##       ##       ##       ## +Target  1 2 + Std  %2d  +\n", game[playing].step);
	printf("+  ############################# +      3 4 5 + Step %3d  +\n", tot_step);
	printf("+                                +      6 7 8 +           +\n");
	printf("+=========================================================+\n");
	printf("+  Note: arrow indicates the direction in which the block +\n");
	printf("+ moves. eg ¡úmove the block to the space on its right.   +\n"); 
	Move(1, 15);
	Set_color :: Yellow();
	printf("      Digit Puzzle    ");
	Move(3, 15);
	Set_color :: Purple();
	printf("Level %d", playing);
	int tmp = 0;
	Move(18, 5);
	Set_color :: Yellow();
...
void Print_home_page()
{
	...
	Set_color :: Cyan();
	printf("+===============================================================+\n");
	printf("+    Game Version : English     +            My Account         +\n");
	printf("+  ###########################  +                               +\n");
	printf("+  #       ##       ##       #  +Achievement                    +\n");
	printf("+  #       ##  ¢ñ 1 ##  ¢ò 2 #  +===============================+\n");
	printf("+  #       ##       ##       #  + You achievement is associated +\n");
	printf("+  ###########################  +       with your rateing       +\n");
	printf("+  #       ##       ##       #  +===============================+\n");
	printf("+  #  ¢ó 3 ##  ¢ô 4 ##  ¢õ 5 #  +                               +\n");
	printf("+  #       ##       ##       #  +                               +\n");
	printf("+  ###########################  +                               +\n");
	...
	printf("+  ###########################  +                               +\n");
	printf("+===============================+===============================+\n");
	printf("+  puzzle game: Digit Puzzle    +        ¡ú¡ú¡ú¡ú¡ú¡ú¡ú¡ú       +\n");
	printf("+  Developed by zhaoxi zheng    +  press ¡ú to the problem set  +\n");
	printf("+===============================================================+\n");
	Move(2, 33);
	Set_color :: Yellow();
	printf(" Level %3d", lev - 1);
	Set_color :: Green();
	printf("  Rateing : %4d", rate);
	Print_lev();
}
...
void Print_counter()
{
	...
	printf("\n");
	Move(++Row, Col); 
	printf("#                              Instructions                #  puzzle game   #\n");
	Move(++Row, Col); 
	printf("# the first number shows the page of the problemset        #  Digit Puzzle  #\n");
	Move(++Row, Col);   
	printf("# the following numbers shous the level you will challenge #                #\n");
	Move(++Row, Col); 
	printf("# use ¡û¡ú¡ü¡ýto move the cursor and resize the numbers    #  Developed by  #\n");
	Move(++Row, Col); 
	printf("# Esc : sign out | Enter : confirm | Alt: see the tutorial #  zhaoxi zheng  #\n");
	Move(++Row, Col); 
	for (int i = 1; i <= 77; ++i)
		printf("#");
	printf("\n");
